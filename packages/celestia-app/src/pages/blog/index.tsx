  ...
  return (
    <div className="h-full mx-12 bg-plum-4 mt-16 rounded-lg overflow-hidden text-gray-11 shadow-lg shadow-black">
      <div className="py-8 px-12">
        ...
        <p className="my-4">
          My day job now is being a junior Software Engineer doing mostly Web development with a touch of data science
          in a small startup company. I wanted to create a side project that incorporated AI/ML, Data Science, DevOps,
        ...
        <p className="my-4">
          And that is where we are now. Please keep in mind THIS IS NOT SOUND FINANCIAL ADVICE. I imagine if you are
          here you understand that already though. AI/ML is not an exact science and has a certain artistic aspect. That
          being said I am just one developer working on this as a side project, predictions may be wrong sometimes or
          all the time, but hopefully through the development of Celestia we will get better with more and more
          capabilities 🚀.
        </p>
        ...
        <p className="my-4">
          ...
          Which consists of the following data values. “average”, “highest”, “lowest”, “order_count”, and “volume”.
          After that we use that data to get a “trend”, and “close_ration” for the next 3, 7, and 14 days for each data
          entry. Then with that we take the “average” for day 0, and the average for day 1 and figure out if it
          increased or decreased. We shift that value to a new column for the next day in the data and call it “target”.
          That is what we are predicting.
        </p>
        <p className="my-4">
        ...
        <p className="my-4">
          ...
          model to predict on ALL OTHER DATA. If that sounds like it might not be the right way to do it you are
          probably correct. Our current model was trained on Punisher’s in Domain. We used a Random Forest and achieved
          an accuracy of 82% on our test set which is pretty good for that item. The issue is that without feedback I
          simply don’t know how well it will perform on that item or other items in the real world.
        </p>

        <p className="my-4">
          Model development is a continuous process. We make predictions, figure out if we were correct or not, tweak
          the model, and try again. Do we tune the model to be more confident when it makes a prediction? What about
          having a model for each item/region combination? What about predicting volume movement instead of average
          increase? There are endless paths to choose from and the feedback that you provide will help me make those
          decisions.
        </p>
